...
public class ShopTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<ShopTenantDatabaseMigrationHandler> _logger;

    public ShopTenantDatabaseMigrationHandler(
        IEnumerable<IShopDbSchemaMigrator> dbSchemaMigrators,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<ShopTenantDatabaseMigrationHandler> logger)
    {
    ...
    public async Task HandleEventAsync(TenantCreatedEto eventData)
    {
        await MigrateAndSeedForTenantAsync(
            eventData.Id,
            eventData.Properties.GetOrDefault("AdminEmail") ?? ShopConsts.AdminEmailDefaultValue,
            eventData.Properties.GetOrDefault("AdminPassword") ?? ShopConsts.AdminPasswordDefaultValue
        );
    }
